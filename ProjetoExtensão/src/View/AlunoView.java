...
import Controle.ControleDeUsuarios ;
import TableModel.UsuarioTM;
...
public class AlunoView extends javax.swing.JFrame {
    ...
    public void LoadTable(){
        Modelo = new UsuarioTM(ControleDeUsuarios .getAlunos());
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        if( ControleDeUsuarios.SalvarAluno(c_mat.getText(),c_nome.getText()) ){
            this.LoadTable();
    ...
    public static void main(String args[]) {
        /* 
Definir o visual e a sensação do Nimbus * /
